...
- **Pinned Cases in Dropdowns**: All case search dropdowns (Tasks, AI Center, Quick Notes, Deadlines, Time Log) show pinned cases in a "📌 Pinned" section at top, followed by "All Cases" section. Uses `getPinnedCaseIds(userId)` from localStorage + `PinnedSectionHeader` component
